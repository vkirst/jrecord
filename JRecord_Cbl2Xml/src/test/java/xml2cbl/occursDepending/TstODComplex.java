package xml2cbl.occursDepending;
...
import xml2cbl.occursDepending.common.ProcessCobolTree;
import xml2cbl.occursDepending.common.TestALine;
...
public class TstODComplex {
	...
	public void testCompexOccursDepending01() {
		...
		ICobol2Xml  cbl2Xml = Cobol2Xml.newCobol2Xml(new StringReader(cobol), cblComplex01.name)
