...
public abstract class PCblBase implements IProcessCobolTree {
	...
	/* (non-Javadoc)
	 * @see json2cbl.occursDepending.common.IProcessCobolTree#intArrayField(java.lang.String, int, json2cbl.occursDepending.common.ArrayIndex)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see json2cbl.occursDepending.common.IProcessCobolTree#startArrayItem(java.lang.String, json2cbl.occursDepending.common.ArrayIndex)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see json2cbl.occursDepending.common.IProcessCobolTree#endArrayItem(java.lang.String)
	 */
	@Override
