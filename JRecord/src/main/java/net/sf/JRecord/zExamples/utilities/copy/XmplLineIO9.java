...
public final class XmplLineIO9 {
	     ...
	     * any of Binary / Flat / CSV / XML.
	     * 
	     * The program demonstrates that reading / writing files
	     * is largely independent of the format.
	     * 
	     */
	    private XmplLineIO9() {
	    ...
	    throws IOException, RecordException {
            ...
            AbstractLineReader reader  = LineIOProvider.getInstance().getLineReader(iLayout);
            AbstractLineWriter writer  = LineIOProvider.getInstance().getLineWriter(oLayout);
