...
public class TestTypeUpdates extends TestCase {
    ...
    private void tstFile(String charset) throws Exception {
        ...
        String dataFileName = TestDataConstants.getTestDataFileName(charset);
        String dataFile = this.getClass().getClassLoader().getResource(dataFileName).getFile();

        r.open(dataFile, td.testDataDefinition);
        try {
