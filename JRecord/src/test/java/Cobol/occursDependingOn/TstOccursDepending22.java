...
package Cobol.occursDependingOn;
 ...
 *
 */
public class TstOccursDepending22 {
	...
	private  void tstPosition(String copybookFile)  throws IOException, RecordException {
		String copybookFileName = TstOccursDepending22.class.getClassLoader().getResource(copybookFile).getFile();
