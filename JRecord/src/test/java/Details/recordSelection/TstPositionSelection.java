...
public class TstPositionSelection extends TestCase {
    ...
    private static String copyBookName = "hdt.cbl";

//	private RecordEditorXmlLoader recordEditorXmlLoader = JRecordInterface1.COBOL.newIOBuilder();
    ...
    public ICobolIOBuilder getBuilder(boolean header, boolean detail, boolean trailer) {
        ICobolIOBuilder ioBuilder = JRecordInterface1.COBOL
                .newIOBuilder(this.getClass().getClassLoader().getResource(copyBookName).getFile())
